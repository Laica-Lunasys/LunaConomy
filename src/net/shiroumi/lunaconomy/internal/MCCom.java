...
import net.shiroumi.lunaconomy.exceptions.BankNameConflictException;
import net.shiroumi.lunaconomy.exceptions.DivideByZeroException;
...
import net.shiroumi.lunaconomy.exceptions.NaturalNumberException;
import net.shiroumi.lunaconomy.exceptions.NoAccountException;
import net.shiroumi.lunaconomy.exceptions.NoBankException;
import net.shiroumi.lunaconomy.exceptions.NoCurrencyException;
import net.shiroumi.lunaconomy.exceptions.NoCurrencyIdException;
...
public class MCCom
{
	private static LunaConomy	plugin	= new LunaConomy();
...
//		}
	...
	/**
	 * Gets an ArrayList with all LunaConomy accounts.
	 * 
	 * @return An ArrayList of LunaConomy Accounts
	 */
...
//	    }
	...
	/**
	 * Returns the name of LunaConomy.
	 * 
	 * @return name
	 */
	...
	/**
	 * Returns the current version of LunaConomy.
	 * 
	 * @return version
	 */
	public static String getVersion()
	{
		return LunaConomy.getVersion();
	}

	/**
	 * Returns the LunaConomy plugin.
	 * 
	 * @return LunaConomy
	 */
