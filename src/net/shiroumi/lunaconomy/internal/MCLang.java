package net.shiroumi.lunaconomy.internal;
...
import net.shiroumi.lunaconomy.internal.util.MCFormat;
...
public class MCLang
{
    private static String langtag = "LunaConomy";
    public static String tag = ChatColor.GREEN + "[" + langtag + "] ";
    
    public static String welcomeMessage = "&fWelcome to LunaConomy, %player%! Your balance is &a%pos-balance%&c%neg-balance% &f%currency%. Type '/lco help' for help.";
    
    public static boolean displayWelcome = false;
    
    public static String messageWelcomeAccountCreated = "&fYour LunaConomy Account has been created!";
    ...
    public static String warnOp = "&eA new version of LunaConomy is available! Download it at http://dev.bukkit.org/server-mods/LunaConomy/";
    ...
    public static String errorCommandRecognition = "&fLunaConomy did not recognize your command. Type &7/lco help &ffor help with LunaConomy commands.";
    ...
    public static String messageHelp1 = "<br>&a===== LunaConomy Help Page 1/3 =====<br>&f<REQUIRED> [OPTION] (OPTIONAL)<br><br>&7/lco help <PAGE>&f - displays this menu.<br>&7/lco balance &for &7/money &f- displays your account balance.<br>&7/lco pay <ACCOUNT> &f- pays specified account.<br>&7/lco get <ACCOUNT> &f- displays specified account's balance.<br>&7/lco set <ACCOUNT> <AMOUNT> &f- sets specified account's balance.<br>&7/lco empty <ACCOUNT> &f- sets specified account's balance to 0.<br>&7/lco create <ACCOUNT> &f- creates new account.<br>&7/lco delete <ACCOUNT> &f- deletes existing account.<br>&7/lco give <ACCOUNT> <AMOUNT> &f- gives specified account the specified amount.<br>&7/lco take <ACCOUNT> <AMOUNT> &f- takes specified amount from the specified account.<br>&7/lco exp &f- displays your amount of experience.";
    public static String messageHelp2 = "<br>&a===== LunaConomy Help Page 2/3 =====<br>&7/lco deposit <TYPE> <AMOUNT> &f- deposits specified amount of physical currency into your account.<br>&7/lco withdraw <TYPE> <AMOUNT> &f- withdraws specified amount of physical currency from your account.<br>&7/lco setcurrency (ACCOUNT) <CURRENCY> &f- sets the specified account's currency.<br>&7/lcob <BANK> &f- displays your balance in the specified bank.<br>&7/lcob balance <BANK> &f- displays your balance in the specified bank.<br>&7/lcob create <BANK> (ACCOUNT) &f- creates new bank/bank account.<br>&7/lcob delete <BANK> (ACCOUNT) &f- deletes specified bank/bank account.<br>&7/lcob get <BANK> <ACCOUNT> &f- displays the balance of specified bank account.<br>&7/lcob set <BANK> <ACCOUNT> &f- sets the balance of specified bank account.";
    public static String messageHelp3 = "<br>&a===== LunaConomy Help Page 3/3 =====<br>&7/lcob empty <BANK> <ACCOUNT> &f- empties the specified bank account.<br>&7/lcob rename <BANK> (ACCOUNT) <NEW_BANK> (NEW_ACCOUNT) &f- renames the specified bank/bank account.<br>&7/lcob transfer <BANK> (ACCOUNT) <TO_BANK> <TO_ACCOUNT> <AMOUNT> &f- transfers the specified amount from bank account to bank account.<br>&7/lcob join <BANK> &f- joins specified bank.<br>&7/lcob leave <BANK> &f- leaves specified bank.<br>&7/lcob deposit <BANK> <AMOUNT> &f- deposits amount in your account.<br>&7/lcob withdraw <BANK> <AMOUNT> &f- withdraws amount from your account.";
    
    public static File                      langFile = new File(
            LunaConomy.maindir + "lang/"
