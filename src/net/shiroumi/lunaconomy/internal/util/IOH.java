...
public class IOH
{
    private static File         dir            = new File(LunaConomy.maindir
                                                       + "lang/");
    private static File         logFile        = new File(LunaConomy.maindir
                                                       + "lang/LunaConomy.log");
    ...
    public static void log(String message, int priority)
    {
        ...
        else if (priority == 1)
        {
            ...
            {
                Logger.getLogger("Minecraft").info(
                        "[LunaConomy] " + "[VERY IMPORTANT] " + message);
            }
    ...
    public static void error(String message, Exception exception)
    {
        ...
        Logger.getLogger("Minecraft").severe("[LunaConomy] [ERROR] " + message);
    ...
    public static void clearLog()
    {
        ...
        log.append("=== LunaConomy Log File ===\n\n");
